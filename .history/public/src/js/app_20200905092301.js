                ...
                <div class="card" >
                    <div class="card-body">
                        ...
                        <p class="card-text">Humidity: <span id="humidity" style="color:cornflowerblue">${data.main.humidity}</span>, Temp: <span id="temp"
                            ...
                            <span style="color:cornflowerblue" id="desc">${data.weather.map(item => item.description)}</span> </p>
...
const GetWeather = (Location) => {
  let url = `https://pro.openweathermap.org/data/2.5/forecast/hourly?q=${Location}&appid=3684b0394f654d433041c59dfbdf9904`;
